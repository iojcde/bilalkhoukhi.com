...
This POC is done using Angular. To view the completed solution head over to [https://github/Bilal-io/Multi-Login-POC](https://github/Bilal-io/Multi-Login-POC).
