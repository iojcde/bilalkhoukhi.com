...
export default function Layout({post}) {
  ...
  return (
    <>
      ...
      <Header />
      <main className="prose lg:prose-xl container w-full max-w-4xl mt-4 lg:mt-8 mb-24 mx-auto px-6 lg:px-0">
        <span className="block border-grey-800 border-b-2 pb-4 mb-12">
